...
//USD/EUR/GBP/NGN/JPY/CNT/RS/BTC
localStorage.setItem('EUR',1.08)
localStorage.setItem('GBP',1.28)
localStorage.setItem('NGN',0.0006)
localStorage.setItem('JPY',0.0066)
localStorage.setItem('CNT',0.00012284)
localStorage.setItem('RS',0.012)
localStorage.setItem('BTC',66059.5)
...
let mainWalletContainer_stakePage=document.querySelector('.mainWalletContainer_stakePage');
...
if(screen.height<=740){
    ...
    mainWalletContainer_stakePage.style.height=`${screen.height}px`;
    ...
    mainWalletContainer_stakePage.style.height=`${screen.height-185}px`;
...
setInterval(()=>{
    ...
    if(Inputcode.value != localStorage.getItem('AmountTransaction')){
        ...
        if(localStorage.getItem('AddressOrCode')==='NaN'){
            document.querySelector('.transaction_SD_RecipientRight').innerText=`UQ${localStorage.getItem('AddressTransaction').slice(0,2)}...max`;
        }else{
            document.querySelector('.transaction_SD_RecipientRight').innerText=localStorage.getItem('AddressTransaction');
        }
